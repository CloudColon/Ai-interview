  ...
  const handleStartInterview = async () => {
    ...
    try {
      ...
      const res = await fetch("http://localhost:8000/api/sessions", {
        ...
        body: JSON.stringify({ job_description_id: Number(id) }),
      });
      const data = await res.json();
      if (res.ok && data.id) {
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .job-header::before {
          ...
          background: radial-gradient(ellipse at 0% 0%, rgba(91,141,238,0.07), transparent 60%);
          pointer-events: none;
        }
        ...
        .start-btn:hover:not(:disabled) { opacity: 0.88; transform: translateY(-2px); box-shadow: 0 10px 32px var(--accent-glow); }
      ...
      <div className="layout">
        ...
        <main className="main">
          <div className="topbar">
            <Link href="/jobdescription" className="back-btn">
              ← Back to Job Descriptions
            </Link>
            <div className="topbar-actions">
              <button className="start-btn" onClick={handleStartInterview} disabled={starting || loading || notFound}>
                ...
                <div className="job-header">
                  <div className="job-header-top">
                    ...
                    <div className="job-badges">
                      ...
                      {job.experience && (
                        <span className="badge badge-exp">⏱ {job.experience}</span>
                      )}
                    </div>
                  </div>
                  ...
                  <button className="start-btn" onClick={handleStartInterview} disabled={starting}>
                    {starting ? <><div className="spinner" /> Starting...</> : <>⚡ Start Interview Now</>}
                  </button>
                </div>
